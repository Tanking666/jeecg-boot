        ...
        <div class="right-center">
            <div class="title-box">
                <p id="switchBtn"><span class="active" data-dataType="income">收入数据</span><img class="line-img"
                                                                                              ...
                                                                                              alt=""><span data-dataType="expend">支出数据</span></p>
                <img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt="">
        ...
        <div class="right-bottom">
            ...
            <div class="data-box">
                <div class="settings-box">
                    <p><img src="${base}/bigscreen/template2/images/teacher_icon.png" alt="">今日值班：<span id="name_a"></span><span id="date_a"></span>
                    </p>
...
<div class="container">
    ...
    <div class="pop-up">
        ...
        <div class="cont-div">
            ...
            <button class="btn-class" data-state=1 id="tabBtns"><img src="${base}/bigscreen/template2/images/chart_icon.png" alt=""><span>图表</span>
            </button>
            <div class="chart-box pop-chart">
